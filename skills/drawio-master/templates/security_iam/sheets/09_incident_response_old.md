# Sheet 9: Incident Response (Old)

> Source: `ACB-SWO_AWS LZ_Security and IAM Design_20260317.drawio` — sheet `Incident Response (Old)`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 1 containers, 15 icons, 2 edges, 3 other

## Containers

**Workload Account** (257.82x690)
```
...
**Security Hub<div>Delegated Administration</div><div>Aggregat** (78x78)
```
...
**Step Functions<div>Workflows</div>** (78x78)
```
...
**Lambda Functions<div>Auto-remediation</div>** (78x78)
```
...
**&nbsp;SSM Documents<div>Runbook</div>** (64x78)
```
...
**Inspector<div>Vulnerability Scanning</div>** (78x78)
```
...
**System Manager<div>Patch Status</div>** (78x78)
```
...
**hrLsQMCaXQUBMJRjIvU5-3**
```
edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;
```

**hrLsQMCaXQUBMJRjIvU5-14**
```
edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0;entryY=0.5;entryDx=0;entryDy=0;
```

## Other Shapes

**hrLsQMCaXQUBMJRjIvU5-2** (370x130)
```
rounded=0;whiteSpace=wrap;html=1;verticalAlign=bottom;
```

**Notifications via Email, MS Teams** (331x40)
```
