# Sheet 3: Security Logging

> Source: `ACB-SWO_AWS LZ_Security and IAM Design_20260317.drawio` — sheet `Security Logging`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 4 containers, 12 icons, 3 edges, 2 other

## Containers

**Log Archive account** (760x270)
```
...
**Information Security account** (520x400)
```
...
**Kinesis Firehose<br>DNS Query Log Stream** (80x80)
```
...
**Administration Delegated<br>GuardDuty** (78x78)
```
...
**e1e2qrHp0fM_jUSva683-12**
```
edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;
```

**e1e2qrHp0fM_jUSva683-19**
```
edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0;exitY=0.501;exitDx=0;exitDy=0;exitPerimeter=0;
```

**e1e2qrHp0fM_jUSva683-25**
```
