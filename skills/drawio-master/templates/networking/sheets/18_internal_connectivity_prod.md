# Sheet 18: Internal connectivity_prod

> Source: `ACB_Networking_diagrams .drawio` — sheet `Internal connectivity_prod`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 3 containers, 4 icons, 1 edges, 5 other

## Containers

**s-jWE2MMU4xsegbEtVm6-6** (620x270)
```
rounded=0;whiteSpace=wrap;html=1;fillColor=none;dashed=1;
```

**Inspection VPC** (280x270)
```
...
**s-jWE2MMU4xsegbEtVm6-20** (180x165)
```
...
**Next Generation Firewall** (60x50.77)
```
...
**Gateway Load<div>Balancer</div>** (60x60)
```
...
**<b>AWS<br>Transit Gateway</b>** (100x30)
```
text;html=1;whiteSpace=wrap;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;rounded=0;
```

**Inspection route table** (290x110)
```
shape=table;startSize=30;container=1;collapsible=0;childLayout=tableLayout;fillColor=#b1ddf0;strokeColor=#10739e;fontStyle=1
```

**s-jWE2MMU4xsegbEtVm6-10** (290x40)
```
...
**s-jWE2MMU4xsegbEtVm6-23** (200x195)
```
group
```
