# Sheet 13: 3rd nonprod party private link - provider

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd nonprod party private link - provider`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 4 containers, 9 icons, 2 edges, 5 other

## Containers

**3rd Party Non-Prod** (1120x580)
```
...
**Ma5xp3v-f7F9mvGDy9CG-20** (150x35)
```
...
**<span style="font-size: 12px;">10.4.40.0/22</span>** (75x28)
```
