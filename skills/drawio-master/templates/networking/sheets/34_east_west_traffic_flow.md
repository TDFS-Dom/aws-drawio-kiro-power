# Sheet 34: East-West-traffic-flow

> Source: `ACB_Networking_diagrams .drawio` — sheet `East-West-traffic-flow`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 7 containers, 7 icons, 7 edges, 4 other

## Containers

**Network Account** (710x510)
```
...
**ENI-1<span style="color: rgba(0, 0, 0, 0); font-family: mono** (50x50)
```
...
**(2)** ()
```
edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];fontSize=12;fontStyle=1;fontColor=#FF9933;
```
...
**G7YL4vBVIGRI0I0zWGvW-1** (680x360)
```
group
```

**Firewall<div>Appliances</div>** (60x63)
```
