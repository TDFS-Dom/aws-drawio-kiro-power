# Sheet 12: 3rd prod party private link - provider

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd prod party private link - provider`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 4 containers, 6 icons, 2 edges, 5 other
