# Sheet 7: Share Prod Service Account

> Source: `ACB_Networking_diagrams .drawio` — sheet `Share Prod Service Account`
...
**Share Service Prod VPC** (600x380)
```
...
**TF9IxOpshxd-_ngBXX4E-1** (160x270)
```
group
```
...
**1<span lang="DE" style="font-size:8.0pt;font-family:&quot;Ar** (125x20)
```
