# Sheet 16: 3rd prod party vpn

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd prod party vpn`
...
**<span style="font-size: 12px;">10.4.36.0/22</span>** (150x29)
```
