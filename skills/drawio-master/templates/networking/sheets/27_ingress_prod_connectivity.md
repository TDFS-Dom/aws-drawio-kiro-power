# Sheet 27: Ingress Prod Connectivity

> Source: `ACB_Networking_diagrams .drawio` — sheet `Ingress Prod Connectivity`
...
**GeimWACvw2LngKRfUdkH-4** (790x350)
```
...
**GeimWACvw2LngKRfUdkH-34** (180x165)
```
...
**GeimWACvw2LngKRfUdkH-2** (790x350)
```
group
```
