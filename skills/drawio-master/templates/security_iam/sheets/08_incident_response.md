# Sheet 8: Incident Response

> Source: `ACB-SWO_AWS LZ_Security and IAM Design_20260317.drawio` — sheet `Incident Response`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 1 containers, 10 icons, 1 edges, 3 other

## Containers

**Workload Accounts** (177.82x460)
```
...
**Security Hub<div>Delegated Administration</div>** (78x78)
```
...
**Event Bridge<div>Event Routing</div>** (78x78)
```
...
**GuardDuty<div>Threat Detection</div>** (78x78)
```
...
**IAM Access Analyzer<div>Permission Analysis</div>** (78x77)
```
...
**AWS Config<div>Configuration Monitoring</div>** (78x78)
```
...
**i88B67pem1Ot5SgAaONc-44** (370x130)
```
rounded=0;whiteSpace=wrap;html=1;verticalAlign=bottom;
```

**Notifications via Email, MS Teams** (210x40)
```
