# Sheet 40: 3rd party ingress private link

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd party ingress private link`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 7 containers, 10 icons, 9 edges, 3 other
