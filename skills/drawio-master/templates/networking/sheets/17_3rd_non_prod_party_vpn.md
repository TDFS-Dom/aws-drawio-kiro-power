# Sheet 17: 3rd non prod party vpn

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd non prod party vpn`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 4 containers, 7 icons, 3 edges, 5 other

## Containers

**3rd Party Non-Prod** (1120x560)
```
...
**Service subnet route table** (300x240)
```
...
**WZyydSxW34SsyHqleA1i-14** (300x37)
```
...
**<span style="font-size: 12px;">10.4.40.0/22</span>** (150x29)
```
...
**TGW subnet route table** (290x130)
```
