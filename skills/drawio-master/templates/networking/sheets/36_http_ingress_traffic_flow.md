# Sheet 36: HTTP Ingress traffic flow

> Source: `ACB_Networking_diagrams .drawio` — sheet `HTTP Ingress traffic flow`
...
**<font style="font-size: 11px;">Application</font><div><font ** (40x40)
```
