# Sheet 23: 3rd Party Production Connectivity

> Source: `ACB_Networking_diagrams .drawio` — sheet `3rd Party Production Connectivity`
> Copy style strings EXACTLY when generating this pattern.

**Elements**: 3 containers, 7 icons, 1 edges, 4 other

## Containers

**v-fO6kwmGrgDvPFIidxU-1** (790x490)
```
...
**4t2nH3EgzL3J3AfOeA-_-2** (180x165)
```
...
**<div>AWS</div>Transit Gateway** (42x42)
```
...
**Virtual<div>Private Gateway</div>** (60x60)
```
...
**Jy_hP0KRm5sgs6Shxym1-5** (300x150)
```
group
```
